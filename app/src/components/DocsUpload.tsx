...
const DocsUpload: React.FC = () => {
  ...
  return (
    ...
    >
      <header className="documents-header w-full max-w-5xl mb-6 bg-gray-800 p-4 rounded-2xl flex justify-between items-center shadow-md" data-aos="fade-down">
      ...
      <div className="documents-content w-full max-w-5xl flex flex-col space-y-6">
        <div className="upload-section bg-gray-800 p-6 rounded-2xl shadow-md flex flex-col items-center" data-aos="fade-up">
